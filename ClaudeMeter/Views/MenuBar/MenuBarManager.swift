...
final class MenuBarManager {
    ...
    private func setupStatusItem() {
        ...
        button.setAccessibilityLabel("QuotaMeter")
    ...
    private func updateIcon() {
        ...
        let remaining = clamped(appModel.usageData?.headlineRemaining ?? 100)
        let secondaryRemaining = clamped(appModel.usageData?.runnerUpRemaining ?? 100)
